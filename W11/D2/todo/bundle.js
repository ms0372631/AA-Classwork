...
/***/ "./frontend/reducers/todo_reducer.js":
/*!*******************************************!*\
  !*** ./frontend/reducers/todo_reducer.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _actions_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/action */ "./frontend/actions/action.js");


var todosReducer = function todosReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state); // old state and new state will be compared
  // to figure out what needs to be updated in views
  // so we must ensure the "state" doesn't change

  var nextState = Object.assign({}, state); // merges all args after the first into the first
...
var configureStore = function configureStore() {
  ...
  console.log('example');
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_root_reducer__WEBPACK_IMPORTED_MODULE_1__["default"], preloadedState);
};
